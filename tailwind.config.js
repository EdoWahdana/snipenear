...
module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      ...
      bodys: ["Poppins", "sans-serif"],
    },
    colors: {
      transparent: "transparent",
      current: "current",
      "dark-green": "#30433A",
      "primary-green": "#2B6F4E",
      white: "#ffffff",
      black: "#000000",
      "blue-gray": {
        50: "#eceff1",
      ...
      eversnipe: "#CCA8B4",
      "eversnipe-hover": "#AE8E99",
      "eversnipe-dark": "#1F192D",
      "eversnipe-dark-hover": "#282332",
      "eversnipe-bg": "#151521",
      "eversnipe-input": "#5F3F5D",
      "eversnipe-text": "#5C4A50",
    },
    extend: {
      fontFamily: {
